...
func testRoomCompositeFile(t *testing.T, conf *Context) {
...
func testRoomCompositeStream(t *testing.T, conf *Context) {
	publishSamplesToRoom(t, conf.room, params.MimeTypeOpus, params.MimeTypeVP8, conf.Muting)
...
func testRoomCompositeSegments(t *testing.T, conf *Context) {
	publishSamplesToRoom(t, conf.room, params.MimeTypeOpus, params.MimeTypeVP8, conf.Muting)
