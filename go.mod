...
require (
	...
	github.com/livekit/livekit-server v1.9.2
	...
	github.com/livekit/server-sdk-go/v2 v2.11.4-0.20251019031212-cb2aaa32eecc
	github.com/livekit/storage v0.0.0-20251008230823-9d7b919e36ab
